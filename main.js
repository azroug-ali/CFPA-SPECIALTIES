...
const specialtiesData = {
    ...
    3: {
        ...
        details: "<h4>وصف تفصيلي:</h4><p>إذا كنت ترغب في تعلّم مهنة فلاحية مطلوبة وسهلة الانطلاق، فإن تخصص المشتلة يمنحك مهارات عملية في إنتاج النباتات والأشجار بطريقة احترافية.</p><P>خلال هذا التكوين ستتعلّم:</p><ul><li>إعداد المشتلة وتنظيم فضاء الإنتاج</li><li>إنتاج شتلات الخضروات، الأشجار المثمرة ونباتات الزينة</li><li>حضير الخلطات الترابية المناسبة لكل نوع</li></ul><br/><p/>"
    },
    4: {
        title: "التركيب الصحي",
...
function togglePopup1() {
    const popup1 = document.getElementById("popupMessage1");
    popup1.classList.toggle("show");
}

// الرسالة الثانية
function togglePopup2() {
    const popup2 = document.getElementById("popupMessage2");
    popup2.classList.toggle("show");
}

// فتح الرسالة الثانية وإغلاق الرسائل تلقائيًا
function openSecondPopup() {
    togglePopup1(); // إغلاق الرسالة الأولى
    togglePopup2(); // فتح الرسالة الثانية
}

document.addEventListener("DOMContentLoaded", function() {
    const faqBtn = document.getElementById("faqFloatingBtn");
    const faqPopup = document.getElementById("faqPopup");
    const faqCloseBtn = document.getElementById("faqCloseBtn");

    // فتح / غلق النافذة عند الضغط على الزر العائم
    faqBtn.addEventListener("click", function() {
        faqPopup.classList.toggle("show");
    });

    // غلق النافذة عند الضغط على ×
...
// منع النقر الأيمن في الصفحة
document.addEventListener('contextmenu', function(e) {
    e.preventDefault();
});

// منع استخدام اختصارات النسخ Ctrl+C / Ctrl+X
...
// منع فتح الصور في نافذة جديدة عند النقر عليها
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const btn = document.getElementById("faqFloatingBtn");
